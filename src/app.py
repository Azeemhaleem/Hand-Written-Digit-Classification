...
with st.sidebar:
    ...
    **Model Details:**
    ...
    - Output: Digit 0-9
    - Location: `models/mnist_prediction_model.h5`
    """)
        ...
        if 'image_ready' in st.session_state and st.session_state.image_ready:
            with st.spinner("🔍 Processing image..."):
                ...
                try:
                    ...
                    # Load model
                    model = load_model('models/mnist_prediction_model.h5')
                    ...
                    st.info("Make sure your model file exists at: models/mnist_prediction_model.h5")
        else:
...
<div style="text-align: center; color: #666; padding: 2rem;">
    ...
    <p>Using your trained model: <code>mnist_prediction_model.h5</code></p>
</div>
""", unsafe_allow_html=True)